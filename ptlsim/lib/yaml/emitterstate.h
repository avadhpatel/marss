...
class EmitterState {
    public:
        ...
        void SetError(const std::string& error) {
            m_isGood = false; m_lastError = error;
        }
        ...
        bool RequiresSeparation() const {
            return m_requiresSeparation;
        }
        void RequireSeparation() {
            m_requiresSeparation = true;
        }
        void UnsetSeparation() {
            m_requiresSeparation = false;
        }
