...
struct TraceDecoder {
    ...
    inline W64 fetch(int n) {
        W64 r = lowbits(*((W64*)&insnbytes[byteoffset]), n*8); rip += n; byteoffset += n; return r;
    }
    inline byte fetch1() {
        byte r = *((byte*)&insnbytes[byteoffset]); rip += 1; byteoffset += 1; return r;
    }
    inline W16 fetch2() {
        W16 r = *((W16*)&insnbytes[byteoffset]); rip += 2; byteoffset += 2; return r;
    }
    inline W32 fetch4() {
        W32 r = *((W32*)&insnbytes[byteoffset]); rip += 4; byteoffset += 4; return r;
    }
    inline W64 fetch8() {
        W64 r = *((W64*)&insnbytes[byteoffset]); rip += 8; byteoffset += 8; return r;
    }
    ...
    bool first_insn_in_bb() {
        return (Waddr(ripstart) == Waddr(bb.rip));
    }
};
...
struct HashtableKeyManager<RIPVirtPhys, setcount> {
    ...
    static inline bool equal(const RIPVirtPhys& a, const RIPVirtPhys& b) {
        return (a == b);
    }
    static inline RIPVirtPhys dup(const RIPVirtPhys& key) {
        return key;
    }
