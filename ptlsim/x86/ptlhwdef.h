...
struct GateDescriptor {
    ...
    GateDescriptor(W16 selector, W64 offset, int type) {
        set_target_and_type(selector, offset, type);
    }
    GateDescriptor(W16 selector, base_function_t func, int type) {
        set_target_and_type(selector, W64(Waddr(func)), type);
    }
...
struct Context : public CPUX86State {
    ...
    void change_runstate(int new_state) {
        running = new_state;
    }
