...
if __name__ == "__main__":
	...
	if not os.path.exists(memlog_file_name):
		...
		if not os.path.exists(memlog_file_name):
			...
			g = [
				...
				,	LinePlot(marss_dt,0,"base_machine.decoder.total_fast_decode","Total decoded") #, [':',2.0,'y'])
	...
	cg = CompositeGraph(title=run_desc,num_cols=1)
	cg.w = 12.0/cg.get_num_cols()
	cg.h = 3*cg.get_num_rows()
